...
function hestia_scripts() {
	...
	if ( ! class_exists( 'Elementor\Frontend' ) ) {
		//wp_enqueue_style( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css', array(), HESTIA_VENDOR_VERSION );
	...
	//wp_enqueue_script( 'jquery-bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js', array( 'jquery' ), HESTIA_VENDOR_VERSION, true );
