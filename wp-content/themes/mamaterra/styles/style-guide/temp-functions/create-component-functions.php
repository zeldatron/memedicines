...
function createOverrideFile($catName, $compName, $settingsArr)
{

    $compDir = $settingsArr[0]['component_directory'];
    $compExt = $settingsArr[0]['component_extension'];

    $myFile = fopen("../../$compDir/$catName/$compName" . "_override" . ".$compExt", 'x+') or die("createOverrideFile: can't open file");
