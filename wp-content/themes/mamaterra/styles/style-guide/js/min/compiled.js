    ...
    $.ajax(this.href, {
        success: function (data) {
            ...
            $('#form-create-category').submit(function (event) {
                ...
                $.ajax({
                        type: 'POST',
                        url: 'style-guide/temp-processing/temp-create-category.php',
                        data: formData,
                        dataType: 'json',
                        encode: true
                    })
                    ...
                    .done(function (data) {
                        ...
                        if (!data.success) {
                            ...
                            window.location = 'style-guide/?cat=' + catName;
                        }
                    })
                    .fail(function (data) {
                        console.log(data);
    ...
    $.ajax(this.href, {
        success: function (data) {
            ...
            $('#form-create-file').submit(function (event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'style-guide/temp-processing/temp-create-component.php',
                    data: formData,
                    dataType: 'json',
                    encode: true
    ...
    $.ajax(this.href, {
        success: function (data) {
            ...
            $('#form-delete-category').submit(function (event) {
                ...
                $.ajax({
                        type: 'POST',
                        url: 'style-guide/temp-processing/temp-delete-category.php',
                        data: formData,
                        dataType: 'json',
                        encode: true
                    })
                    .done(function (data) {
                        if (!data.success) {
                            ...
                            window.location = 'style-guide/index.php';
            ...
            $('#form-edit-category').submit(function (event) {
                ...
                $.ajax({
                        type: 'POST',
                        url: 'style-guide/temp-processing/temp-edit-category.php',
                        data: formData,
                        dataType: 'json',
                        encode: true
                    })
    ...
    $.ajax(this.href, {
        success: function (data) {
            ...
            $('#edit-comp-file').submit(function (event) {
                ...
                $.ajax({
                        type: 'POST',
                        url: 'style-guide/temp-processing/temp-edit-component.php',
                        data: formData,
                        dataType: 'json',
                        encode: true
                    })
            ...
            $('#delete-comp-file').submit(function (event) {
                ...
                $.ajax({
                        type: 'POST',
                        url: 'style-guide/temp-processing/temp-delete-component.php',
                        data: formData,
                        dataType: 'json',
                        encode: true
                    })
        ...
        success: function (data) {
           ...
           var currentCat = $('.atomic-h1').text();
            ...
            $('#form-edit-settings').submit(function (event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'style-guide/temp-processing/temp-edit-settings.php',
                    data: formData,
                    dataType: 'json',
                    encode: true
                })
                    ...
                    .done(function (data) {
                        ...
                        if (!data.success) {
                           ...
                           window.location = 'style-guide/?cat='+currentCat+'';
...
$('#importForm').submit(function (event) {
    ...
    $.ajax({
            type: 'POST',
            url: 'style-guide/temp-processing/temp-import.php',
            data: formData,
            dataType: 'json',
            encode: true
...
$('.editorMode').find(".atoms-nav ").sortable({
    ...
    onEnd: function (evt) {
        ...
        $.ajax({
                type: 'POST',
                url: 'style-guide/temp-processing/temp-nav-cat-sort.php',
                data: formData,
                dataType: 'json',
                encode: true
            })
...
$('.editorMode').find(".aa_fileSection").sortable({
    ...
    onUpdate: function (evt) {
       ...
       formData.push({
        ...
        $.ajax({
                type: 'POST',
                url: 'style-guide/temp-processing/temp-nav-comp-sort.php',
                data: formData,
                dataType: 'json',
                encode: true
            })
     ...
     onAdd: function (evt) {
         ...
         $.ajax({
                 type: 'POST',
                 url: 'style-guide/temp-processing/temp-nav-compCat-sort.php',
                 data: formData,
                 dataType: 'json',
                 encode: true
             })
                 ...
                 if (!data.success) {
                     if (data.errors.exists) {
                         ...
                         $('.atoms-main').prepend('<div class="aa_errorBox"><p class="aa_errorBox__message"><i class="fa fa-times aa_js-errorBox__close"></i> ' + data.errors.exists + '</p></div>').find('.aa_errorBox').hide().fadeIn(200).delay(1000)
                             .queue(function () {
                                 window.location = 'style-guide/?cat='+oldCat+'';
                             });
                     ...
                     console.log('success');
                     window.location = 'style-guide/?cat='+newCat+'';
                 }
             })
             .fail(function (data) {
                 console.log('failed');
...
$('.atomic-editorWrap').submit(function (event) {
    ...
    var newOverrideCode = $(this).closest('.tab-content').find("input[name=new-override-val-"+compName+"]").val();
    ...
    var formData = {
        ...
        'newOverrideCode': newOverrideCode,
        'newJsCode': newJsCode
    };

    $.ajax({
            type: 'POST',
            url: 'style-guide/temp-processing/temp-editor.php',
            data: formData,
            dataType: 'json',
            encode: true
        })
