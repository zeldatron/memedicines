...
$newOverrideCode = $_POST["newOverrideCode"];
...
if ( ! empty($errors)) {
    ...
    function editorCodeUpdate($compName,$catName,$newMarkupCode, $newStylesCode, $newJsCode, $newOverrideCode, $settingsArr){
    //function editorCodeUpdate($compName,$catName,$newMarkupCode, $newStylesCode, $newJsCode, $settingsArr){
        ...
        $overridePath = '../../' . $compDir . '/' . $catName . '/'.$compName.'_override.'. $compExt .'';
        file_put_contents($overridePath, $newOverrideCode);
    ...
    editorCodeUpdate($compName,$catName,$newMarkupCode, $newStylesCode, $newJsCode, $newOverrideCode, $settingsArr);
