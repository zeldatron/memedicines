...
foreach ($cat_data as $cat_value) {
        ...
        <li class="aa_dir ">
            <div class="aa_dir__dirNameGroup">
                ...
                <a class="aa_dir__dirNameGroup__name"
                   ...
                   href="style-guide/?cat=<?php echo $cat_value['cat_name'] ?>"><?php echo $cat_value['cat_name'] ?></a>
            </div>
            <ul class="aa_fileSection">
                <li class="aa_addFileItem">
                    <a class="aa_addFile js_add-edit-c omponent aa_js-actionOpen aa_actionBtn"
                       href="style-guide/temp-forms/temp-component-form.php"
                       data-cat="<?php echo $cat_value['cat_name'] ?>">
                ...
                <li class="aa_fileSection__file" data-comp="<?php echo $comp_value['comp_name'] ?>">
                    <a href="style-guide/?cat=<?php echo $cat; ?>#<?php echo $comp_value['comp_name'] ?>"><?php echo $comp_value['comp_name'] ?></a>
                </li>
    ...
    <h1 id="modules" class="atomic-h1"><?php echo $_GET['cat']; ?> <a class="fa fa fa-pencil-square-o js_add-edit-component aa_js-actionOpen aa_actionBtn" href="style-guide/temp-forms/temp-category-form.php">
        ...
        <div id="<?php echo $comp_value['comp_name'] ?>-container" class="compWrap">
            ...
            <div class="component"
                ...
                <iframe class="partial-viewport"
                        src="style-guide/partial.php?component=<?php echo $comp_value['comp_name'] ?>&category=<?php echo $cat; ?>"
